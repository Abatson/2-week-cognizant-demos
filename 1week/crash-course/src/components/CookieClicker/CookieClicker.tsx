...
export const CookieClicker: React.FunctionComponent<any> = (props) => {
    ...
    return (
        <div className="cookie-clicker-container">
            <figure>
                ...
                <figcaption>You have {cookies.toFixed(0)} number of Cookies</figcaption>
                <figcaption>You are making {cookiesPerSecond} cookies per second</figcaption>
            </figure>
